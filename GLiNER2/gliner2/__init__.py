# Modified by NewMind AI in 2026 from fastino-ai/GLiNER2 commit 3c913c7: adds the __nm_kvkk__ marker.
...
__version__ = "2.0.0"
__nm_kvkk__ = True   # this is the nm-kvkk fork (native tokenization, add_bos, mean pooling for Mursit encoders)
